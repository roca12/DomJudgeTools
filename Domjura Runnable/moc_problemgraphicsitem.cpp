...
void DJ::View::ProblemGraphicsItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<ProblemGraphicsItem *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DJ::View::ProblemGraphicsItem::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_DJ__View__ProblemGraphicsItem.data,
    qt_meta_data_DJ__View__ProblemGraphicsItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
